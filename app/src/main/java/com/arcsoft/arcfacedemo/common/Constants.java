...
public class Constants {
    ...
    public static final String APP_ID = "8ppRxTXum22ciKMFd32kk6wKhJ9JNrD4q8WRnqiS1apT";
    public static final String SDK_KEY = "3VQLYUJUHzQ5sikkJc7wD7JxSwiY8a942J6z3xPvjqge";
